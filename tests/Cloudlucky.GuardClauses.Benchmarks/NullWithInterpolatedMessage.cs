...
public class NullWithInterpolatedMessage
{
    ...
    public void Imperative(string value)
    {
        try
        {
            if (value is null)
            {
                throw new ArgumentNullException(nameof(value), $"The value {value} is null");
            }
        }
        catch
        {
    ...
    public void Current(string value)
    {
        try
        {
            Guard.Against.Null(value, $"The value {value} is null");
        }
        catch
        {
        }
    ...
    public void ArdalisGuardClauses(string value)
    {
        try
        {
            global::Ardalis.GuardClauses.Guard.Against.Null(value, nameof(value), $"The value {value} is null");
        }
        catch
        {
        }
    ...
    public void DawnGuard(string value)
    {
        try
        {
            Dawn.Guard.Argument(value).NotNull($"The value {value} is null");
        }
        catch
        {
        }
    ...
    public void LiteGuardClauses(string value)
    {
        try
        {
            value.MustNotBeNull($"The value {value} is null");
        }
        catch
        {
        }
